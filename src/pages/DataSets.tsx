    ...
    <>
      <ContentContainer>
        ...
        <div className="flex items-center justify-between mb-5">
         ...
         <input type="text" placeholder="Search" className="rounded-full px-4 py-2 w-full max-w-[250px] border-solid border border-black outline-none text-black placeholder:text-black" />
        </div>
